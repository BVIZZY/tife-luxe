    ...
    <div className="min-h-screen text-white font-sans selection:bg-amber-500 selection:text-black">
      ...
      <header className="p-6 flex justify-between items-center bg-transparent max-w-6xl mx-auto">
        ...
        <button 
          ...
          className="bg-amber-500 text-black hover:bg-amber-600 transition-all duration-300 text-xs tracking-widest uppercase px-6 py-2 rounded-sm font-bold shadow-md"
        >
          Book Now
        </button>
      </header>
      ...
      <main className="max-w-4xl mx-auto text-center px-4 pt-16 pb-24">
        ...
        <button 
          onClick={() => setIsOpen(true)}
          className="bg-amber-500 hover:bg-amber-600 text-black font-semibold text-xs tracking-widest uppercase px-8 py-4 transition-all duration-300 shadow-lg shadow-amber-500/20"
        >
          Schedule Session
        </button>
      </main>
      ...
      {/* Menu Section */}
      <section className="max-w-3xl mx-auto px-4 py-16 bg-neutral-950/40 backdrop-blur-md rounded-xl border border-zinc-900/50 mb-16">
        ...
        <div className="space-y-6">
          {services.map((service, index) => (
            <div 
              key={index} 
              className="p-5 rounded-lg border border-zinc-900 bg-black/30 hover:border-amber-500/30 transition-all duration-300 flex justify-between items-start group"
            >
              <div>
              ...
              <div className="flex flex-col items-end gap-2">
                ...
                <button 
                  ...
                  className="text-[10px] uppercase tracking-wider border border-amber-500/40 px-2 py-1 rounded text-zinc-300 hover:bg-amber-500 hover:text-black transition-all"
                >
                  Select
                </button>
              </div>
